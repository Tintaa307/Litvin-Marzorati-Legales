...
export default function Home() {
  ...
  return (
    <div>
      ...
      <Hero locale={locale} head1={tHero('head1')} head2={tHero('head2')} type1={tHero('type1')} type2={tHero('type2')} type3={tHero('type3')} type4={tHero('type4')} type5={tHero('type5')} type6={tHero('type6')} fact1={tHero("fact1")} fact2={tHero("fact2")} fact3={tHero("fact3")} cta1={tHero("cta1")} cta2={tHero("cta2")}></Hero>
      <Services></Services>
