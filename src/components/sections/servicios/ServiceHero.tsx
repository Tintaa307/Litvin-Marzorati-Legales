            ...
            <div className="main-padding mt-64">
                <div className="flex gap-3 h-max">
                    ...
                    <div className="text-white flex flex-col gap-3 max-w-[50rem]">
                        ...
                        <h2 className="font-poppins sm:text-[1.5rem] text-[1.25rem] font-medium">Somos un estudio líder y visionario en el ámbito de la propiedad intelectual e inteligencia artificial.</h2>
                    </div>
                </div>
            </div>
        </div>
