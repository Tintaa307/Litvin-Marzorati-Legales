...
const LogoMarquee = () => {
    return (
        <div className="relative flex justify-center items-center overflow-x-hidden bg-surface-raised">
            <span className='absolute bg-linear-to-r from-transparent from-10% to-surface-raised to-60% sm:w-[40%] w-[20%] right-0 h-full z-10'></span>
            <span className='absolute bg-linear-to-l from-transparent from-10% to-surface-raised to-60% sm:w-[40%] w-[20%] left-0 h-full z-10'></span>
